<template>
  <nav :class="classes" class="navbar">
    <div class="w-100 container" style="text-align: center;">
      <div class="navbar-translate justiby-content-around">
      ...
      <div
        ...
        id="navigation"
        style="background-image: url('img/night.png'); background-repeat: no-repeat; background-color: #000403"
      >
